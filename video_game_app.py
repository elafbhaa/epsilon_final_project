...
# =================================================
    ...
    @st.cache_resource
    def load_pipeline():
        file_id = "1vqi2Szsy1kzeH5yWqlJojNLKwD7qocv6"
        url = f"https://drive.google.com/uc?id={file_id}"
        output = "video_game_model.pkl"
    ...
    if st.button("Predict Global Sales"):
        try:
            ...
            st.success(f"Predicted Global Sales: {round(prediction, 2)} million")
